...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.main_window_stack = QStackedWidget(self.centralwidget)
        self.main_window_stack.setObjectName(u"main_window_stack")
        ...
        self.create_list_button = QPushButton(self.home_page)
        self.create_list_button.setObjectName(u"create_list_button")

        self.gridLayout.addWidget(self.create_list_button, 1, 1, 1, 1)

        self.horizontalSpacer_2 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout.addItem(self.horizontalSpacer_2, 0, 2, 1, 1)

        self.main_window_stack.addWidget(self.home_page)

        self.verticalLayout.addWidget(self.main_window_stack)
